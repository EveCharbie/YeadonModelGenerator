    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.show_analyses_panel:
            ...
            self.play_stop_push_button: QPushButton or None = None
            ...
            self.active_analyses: AnalysePanel or None = None
            self.column_stretch = 0
            self.analyses_layout = QHBoxLayout()
            self.analyses_c3d_editor: AnalysePanel or None = None
            self.analyses_muscle: AnalysePanel or None = None
            self.analyses_ligament: AnalysePanel or None = None

            self.c3d_file_name = None
            self.radio_c3d_editor_model: QRadioButton or None = None
